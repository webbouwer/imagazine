...
jQuery(window).load(function() {
    ...
    jQuery('.imagazine-hidden-categories').each(function(){
        ...
        jQuery('#' + id).closest('li').find('.imagazine-category-checkbox').each(function() {
    ...
    jQuery('.imagazine-category-checkbox').live('change', function(){

        var id = jQuery(this).closest('li').find('.imagazine-hidden-categories').prop('id');
        var elementID = jQuery(this).prop('id').split('-');
